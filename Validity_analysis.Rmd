...
Cooperation and **engageable** are significant predictors of OCBs. 
...
Stress tolerante, **mindful**, **principled**, **though mind** and **hexaco** are all significant predictors of CWBs.
...
**Mindful**, though mind and hexaco are significant predictors of task performance. 
```{r}
...
Influencing, initiative, **stress tolerance**, **engageable**, **though mind** and hexaco are significant predictors of intention to leave.
```{r}
...
**Achievement oriented**, **adaptable**, **analytical thinking**, **energetic**, methodical, **concern for others**, **multitasking**, mindful, **principled**, and **engageable** are all significant predictors of engagement.
...
Methodical, **stress tolerance**, mindful, **principled**, **though mind**, and hexaco are significant predictors of incivility. 
...
Assertive, **creative**, influencing, and engageable are significant predictors of idk. 
