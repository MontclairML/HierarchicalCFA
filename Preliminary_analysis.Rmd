...
final_data2<-final_data%>%add_column(hexHone, hexOpen, hexCons, hexAgree, hexExtra, hexEmo)
...
extraversion<-data.framet(Assertive, Energetic, Competitive, Initiative, Influencing, Persistence, Engageable, hexExtra)
